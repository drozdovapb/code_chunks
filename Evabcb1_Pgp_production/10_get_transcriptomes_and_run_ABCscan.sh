...
## TransDecoder
for assembly in /media/tertiary/Alena_Kizenko/transcriptome_assemblies/rnaspades_reassemblies/*_rnaspades.fasta; do TransDecoder.LongOrfs -t $assembly; TransDecoder.Predict -t $assembly --single_best_only; rm -r *dir*; done
...
scp -P 627 -r drozdovapb@bioinformatics.isu.ru:/media/main/sandbox/drozdovapb/PGP/2021/transdecoder/cdhit_aa .
...
## So. I want to have the names in fasta headers
...
python2 /media/secondary/apps/busco/scripts/run_BUSCO.py -i ~/PGP/2021/transdecoder/Helicoverpa_armigera_SRR4242253_spades.fasta -o Helicoverpa_armigera_SRR4242253_busco -l /media/tertiary/lineage/arthropoda_odb9/ -m transcriptome -c 1 -t 8
python2 /media/secondary/apps/busco/scripts/run_BUSCO.py -i ./transdecoder/cdhit_aa/GFWI01.1.fsa_nt.transdecoder.pep.repr.faa -o Helicoverpa_armigera_GFWI_pep_cdhit_busco -l /media/tertiary/lineage/arthropoda_odb9/ -m proteins -c 1 -t temp
